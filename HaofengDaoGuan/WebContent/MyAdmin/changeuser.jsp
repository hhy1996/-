					...
					<div class="row">
						<div
							...
							<div class="block">
								...
								<form id="form-validation" action="AddDeleteUser" method="post"
									class="form-horizontal form-bordered">
									<div class="form-group">
										<p class="col-md-3 control-label">待修改的用户名</p>
										<div class="col-md-6">
									...
									<div class="form-group">
										<p class="col-md-3 control-label" for="val-password">新密码</p>
										<div class="col-md-6">
									...
									<div class="form-group form-actions">
										<div class="col-md-8 col-md-offset-5">
											<button type="submit"
												class="btn btn-effect-ripple btn-primary">确认</button>
										</div>
									</div>
								</form>
