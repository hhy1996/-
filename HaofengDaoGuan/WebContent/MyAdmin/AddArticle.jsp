    ...
    <body>
						...
						<div class="row">
							<div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
                                ...
                                <div class="block">
                                    ...
                                    <form id="article_form" action="PubArticle" method="post" class="form-horizontal form-bordered ui-formwizard">
                                        <!-- First Step -->
                                        <div id="clickable-first" class="step ui-formwizard-content" style="display: block;">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label" for="example-clickable-username">标题</label>
                                                <div class="col-md-6">
                                                    <input type="text" id="example-clickable-username" name="title" class="form-control ui-wizard-content" placeholder="请输入标题">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div id="toolbar" style="border: 1px solid #ccc;">
												</div>
												<div id="editor" style="border: 1px solid #ccc;height:500px;">
												</div>
												<input type="hidden" id="htmlCode" name="htmlCode" value="">
												<input type="hidden" id="textCode" name="textCode" value="">
                                            </div>
                                            <div class="form-group form-actions">
                                                <div class="col-md-8 col-xs-offset-5">
													<button class="btn btn-effect-ripple btn-primary" onClick="Publish();" style="overflow: hidden; position: relative;">确认发布</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END First Step -->
		...
		<script type="text/javascript">
			...
			function Publish()
			{
				...
				var textcode=editor.txt.text();
				document.getElementById('htmlCode').value=htmlcode;
				document.getElementById('textCode').value=textcode;
				if(htmlcode=="")
				{
					alert('请先输入文章内容值!');
					return false;
