...
<%
	...
	String img1 = (String) request.getAttribute("lunboimg1");
	String img2 = (String) request.getAttribute("lunboimg2");
	String text1 = (String) request.getAttribute("lunbotext1");
	String text2 = (String) request.getAttribute("lunbotext2");
	String link = (String) request.getAttribute("lunbolink");
%>
<!DOCTYPE html>
<html>
<!--<![endif]-->
					...
					<div class="row">
						<div
							...
							<div class="block">
								...
								<form id="form-validation" action="AddDeleteLunBo" method="post"
									class="form-horizontal form-bordered" enctype ="multipart/form-data"
									>
									<div class="form-group" style="display:none">
										<p class="col-md-3 control-label" for="val-password"></p>
										<div class="col-md-6">
											<input type="text" id="val-password" name="lunboid"
									...
									<div class="form-group">
										<p class="col-md-3 control-label" for="val-password">标题</p>
										<div class="col-md-6">
