...
%>
<%
	List<Admin> admin = (List<Admin>) request.getAttribute("admindata");
	if (admin == null) {
		response.sendRedirect("Chakanyonghu");
		return;
	}
%>
<!DOCTYPE html>
	...
	<div id="page-wrapper" class="page-loading">
		...
		<div id="page-container" class="header-fixed-top sidebar-visible-lg-full">
			...
			<div id="sidebar">
				...
				<jsp:include page="header.jsp?active=13" flush="true"></jsp:include>
			</div>
			<!-- END Main Sidebar -->
								...
								<table class="table table-borderless table-vcenter">
									...
									<tbody>
										...
										<tr class="active">
											...
											<td><strong><%=admin.get(i).getID()%></strong></td>
											<td><%=admin.get(i).getPwd()%></td>

											<td class="text-center"><a href="ChangeUser?id=<%=admin.get(i).getID() %>"
												data-toggle="tooltip" title="修改用户"
												class="btn btn-effect-ripple btn-xs btn-success"><i
													class="fa fa-pencil"></i></a> <a href="DeleteUser?id=<%=admin.get(i).getID() %>"
