						...
						<div class="row">
							...
							<!-- Horizontal Form Block -->
                                <div class="block">
                                    ...
                                    <form action="AdminFirstLevel?action=add" method="post" class="form-horizontal form-bordered">
                                        <div class="form-group">
                                            <label class="col-md-2 control-label col-md-offset-1" for="example-hf-email">大类名称</label>
                                            <div class="col-md-6">
                                                <input type="text" id="example-hf-email" name="typeName" class="form-control" placeholder="请输入课程大类名称">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 col-md-offset-1 control-label" for="example-hf-password">大类介绍信息</label>
                                            <div class="col-md-8">
                                                <input type="text" id="example-hf-password" name="typeIntroduce" placeholder="请输入大类描述信息" class="form-control">
                                            </div>
                                        </div>
