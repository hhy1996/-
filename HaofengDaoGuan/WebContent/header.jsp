			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li id="1" <%if(index==1){%>class="active"<%}%>><a href="<%if(needback){%>../<%} %>HomePage">首页</a></li>
						<li id="2" <%if(index==2){%>class="active"<%}%>><a href="<%if(needback){%>../<%} %>Course">课程</a></li>
						<li id="4" <%if(index==4){%>class="active"<%}%>><a href="<%if(needback){%>../<%} %>Map">全国中心</a></li>
						<li id="5" <%if(index==5){%>class="active"<%}%>><a href="<%if(needback){%>../<%} %>Blog">浩枫动态</a></li>
						<li id="6" <%if(index==6){%>class="active"<%}%> class="dropdown "><a href="#" class="dropdown-toggle "
							data-toggle="dropdown" data-hover="dropdown" data-delay="0"
							data-close-others="false">关于浩枫<b class=" icon-angle-down"></b></a>
							<ul class="dropdown-menu">
								<li><a href="<%if(needback){%>../<%} %>about.jsp">公司介绍</a></li>
								<li><a href="<%if(needback){%>../<%} %>contact.jsp">联系我们</a></li>
							</ul></li>
					</ul>
				</div>
			</div>
