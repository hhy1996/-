         ...
         <div class="container">
             <div class="row">
                 <div class="col-lg-12 col-sm-12">
                    <h1>M.D.K Taekwondo Course</h1>
					<br />
					<p>We have researched WTTP （World Taekwondo Training Program）courses for many years , and have developed our special courses at different ages by which we have trained lots of skilled black belts with great passion for taekwondo. </p>
                 </div>
             </div>
         </div>
     </div>
    ...
    <div class="container">
        ...
        <div class="gallery-container">
            <ul id="filters" class="list-unstyled">
                <li><a href="#" data-filter="*"> All Courses</a></li>
