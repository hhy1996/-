	...
	<div id="page-wrapper" class="page-loading">
		...
		<div id="page-container"
			...
			<div id="sidebar">
				...
				<jsp:include page="header.jsp?active=10" flush="true"></jsp:include>
			</div>
			<!-- END Main Sidebar -->
			...
			<div id="main-container">
				...
				<ul class="nav navbar-nav-custom pull-right">
					<!-- User Dropdown -->
					<li class="dropdown"><a href="Logout"><button type="button"
								class="btn btn-default">注销</button></a></li>
					<!-- END User Dropdown -->
				</ul>
					...
					<div class="row">
						<div
							...
							<div class="block">
								...
								<form id="form-validation" action="AdminChangeShop?action=change&shopID=<%=shopID%>"
									method="post" class="form-horizontal form-bordered">

									<div class="form-group">
										<p class="col-md-3 control-label" for="val-password">店铺名称
										</p>
										<div class="col-md-6">
											<input type="text" value="<%=shopInfo.getShopName() %>" id="val-password" name="shopname"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										<p class="col-md-3 control-label" for="val-password">店铺所在省</p>
										<div class="col-md-6">
											<input type="text" value="<%=shopInfo.getShopProvince() %>" id="val-password" name="province"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										<p class="col-md-3 control-label" for="val-password">店铺经纬度</p>
										<div class="col-md-6">
											<input type="text" id="val-password" value="<%=shopInfo.getShopAddress() %>" name="address"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										<p class="col-md-3 control-label" for="val-password">店铺地址</p>
										<div class="col-md-6">
											<input type="text" id="val-password" value="<%=shopInfo.getShopWay() %>" name="way"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										<p class="col-md-3 control-label" for="val-password">店铺电话</p>
										<div class="col-md-6">
											<input type="text" id="val-password" value="<%=shopInfo.getShopTel() %>" name="tel"
												class="form-control">
										</div>
									</div>
