	...
	<div id="page-wrapper" class="page-loading">
		...
		<div id="page-container"
			...
			<div id="sidebar">
				...
				<jsp:include page="header.jsp?active=11" flush="true"></jsp:include>
			</div>
			<!-- END Main Sidebar -->
					...
					<div class="row">
						<div
							...
							<div class="block">
								...
								<form id="form-validation" action="AddShop"
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" id="val-password" name="shopname"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" id="val-password" name="province"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" id="val-password" name="address"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" id="val-password" name="way"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" id="val-password" name="tel"
												class="form-control">
										</div>
									</div>
