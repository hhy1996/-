...
%>
<%
	List<ShopInfo> shopinfo = (List<ShopInfo>) request.getAttribute("shopdata");
	if (shopinfo == null) {
		response.sendRedirect("Chakandianpu");
		return;
	}
%>
<!DOCTYPE html>
								...
								<table class="table table-borderless table-vcenter">
									...
									<tbody>
										...
										<tr class="active">
											...
											<td><%=shopinfo.get(i).getShopName()%></td>
											<td><%=shopinfo.get(i).getShopProvince()%></td>
											<td><%=shopinfo.get(i).getShopAddress() %></a></td>
											<td><%=shopinfo.get(i).getShopWay() %></td>
											<td><%=shopinfo.get(i).getShopTel() %></td>
											<td class="text-center">
											<a href="AdminChangeShop?action=jumpChange&shopID=<%=shopinfo.get(i).getID()%>"
												data-toggle="tooltip" title="修改店铺"
												class="btn btn-effect-ripple btn-xs btn-success"><i
													class="fa fa-pencil"></i></a> 
											<a href="AdminChangeShop?action=delete&deleteID=<%=shopinfo.get(i).getID()%>"
												data-toggle="tooltip" title="删除店铺"
