				...
				<div class="blog-item">
					<div class="row">
						...
						<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
							...
							<p class="visible-xs">
								<strong>Pubdate:<%=_time[0]%>.<%=_time[1]%>.<%=_time[2]%></strong>
							</p>
							<p><%=_split[1]%></p>
							<a href="Article/<%=_split[2]%>" class="btn btn-danger">Read more</a>
						...
						<div class="text-center">
							<ul class="pagination">
								<%
									if (is1display) {
								%>
								<li><a href="Blog?pageid=<%=id - 1%>">Previous page</a></li>
								<%
									}
								%>
							</ul>
						...
						<div class="text-center">
							<ul class="pagination">
								<%
									if (is2display) {
								%>
								<li><a href="Blog?pageid=<%=id + 1%>">Next page</a></li>
								<%
									}
								%>
							</ul>
