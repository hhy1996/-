				...
				<ul id="revolutionul" style="display:none;">
					...
					<li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="">
						...
						<a class="caption lft slide_btn btn red slide_item_left" href="<%=lunbo.get(i).getLink()%>" target="_blank" data-x="30" data-y="420" data-speed="400" data-start="3000" data-easing="easeOutExpo">
							<font class="hidden-xs" size="4">click to enter</font>
							<font class="visible-xs" style="margin-top:8px;margin-bottom:8px" size="3">click to enter</font>
						</a>
							...
							<li class="mis-slide">
								...
								<a href="#" class="mis-container">
									...
									<figure>
										...
										<br/><br/>
										<figcaption>Inspire active learning</figcaption>
									</figure>
								</a>
							</li>
							<li class="mis-slide">
								<a href="#" class="mis-container">
									<figure>
										...
										<br/><br/>
										<figcaption>Different styles at different ages</figcaption>
									</figure>
								</a>
							</li>
							<li class="mis-slide">
								<a href="#" class="mis-container">
									<figure>
										...
										<br/><br/>
										<figcaption>80 minutes long</figcaption>
									</figure>
								</a>
							</li>
							<li class="mis-slide">
								<a href="#" class="mis-container">
									<figure>
										...
										<br/><br/>
										<figcaption>Small class</figcaption>
									</figure>
								</a>
							</li>
							<li class="mis-slide">
								<a href="#" class="mis-container">
									<figure>
										...
										<br/><br/>
										<figcaption>Internationally advanced courses</figcaption>
									</figure>
								</a>
							</li>
							<li class="mis-slide">
							...
							<li class="mis-slide">
								<a href="#" class="mis-container">
									<figure>
										...
										<br/><br/>
										<figcaption>Chinese traditional strategics</figcaption>
									</figure>
								</a>
							</li>
						</ol>
		...
		<section class="gray-bg">
			<div class="container">
				<div class="text-center feature-head" style="margin-bottom:-70px;">
					<h1>Main Courses</h1>
					<p>Strengthen your fitness in fashion and interesting taekwondo training programme.</p>
					<p>Cultivate your leadership in original and inspiring management courses.</p>
				</div>
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
						<div class="element flat item view view-tenth" data-zlname="reverse-effect" style="margin-bottom:10px;">
							...
							<div class="mask" style="background-color:rgba(	219,112,147,0.5);">
								<h2 style="margin-top:5%;color:white;">Strengthen your fitness in fashion and interesting taekwondo training programme.</h2>
								<a href="Course?chooseType=0" data-zl-popup="link" href="javascript:;">
									<i class="icon-link"></i>
								</a>
							</div>
						</div>
						<p><a href="Course?chooseType=0">Taekwondo</a></p>
						<br/>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
						<div class="element flat item view view-tenth" data-zlname="reverse-effect" style="margin-bottom:10px;">
							...
							<div class="mask" style="background-color:rgba(	100,149,237,0.5);">
								<h2 style="margin-top:5%;color:white;">Cultivate your leadership in original and inspiring management courses.</h2>
								<a href="Course?chooseType=1" data-zl-popup="link" href="javascript:;">
									<i class="icon-link"></i>
								</a>
							</div>
						</div>
						<p><a href="Course?chooseType=1">Comprehensive expansion</a></p>
						<br/>
					</div>
				</div>
				<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"></div>
